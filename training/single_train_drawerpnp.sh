...
# This mirrors single_train_box.sh, but targets the composed drawer-open
# and pick-place task from the sequential drawer/pnp family.

# Configuration
WANDB_ENTITY="haoyu-a2i"
WANDB_PROJECT="Metaworld_Dreamerv3_Single"
RUN_NAME="mw_single_drawerpnp_$(date +%m%d)"
